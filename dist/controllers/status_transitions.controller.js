...
const statusTransitionController = {
    ...
    addStatusTransitions: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const isCurrentStatusAvailable = yield status_service_1.default.isAvailable(current_status);
            const isNewStatusAvailable = yield status_service_1.default.isAvailable(new_status);
