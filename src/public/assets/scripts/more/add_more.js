...
function openModal(entityName, entityType, entityIdField, entityNameField, apiEndpoint, tableId, editFunction) {
    ...
    form.innerHTML = `
      <h2 class="text-xl font-bold mb-4">Thêm ${entityName}</h2>
      <div class="grid grid-cols-2 gap-4">
      <div>
            <label for="${entityIdField}" class="block text-sm font-medium text-gray-700">ID:</label>
            <input type="text" id="${entityIdField}" name="${entityIdField}" required
